    ...
    public partial class Login : Form
    {
        ...
        private void btlogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (count > 0)
                {
                    //string userType = dt.Rows[0]["Loai_nguoi_dung"].ToString();
                    //if (userType == "admin")
                    //{
                    //    // Đăng nhập thành công với tư cách admin
                    GymDataFormRec homeRec = new GymDataFormRec();
                    homeRec.Show();
                    //}
                    //if (userType == "pt")
                    //{
                    //    // Đăng nhập thành công với tư cách PT
                    //    GymDataFormPT homePT = new GymDataFormPT();
                    //    homePT.Show();
                    //}
                    this.Hide();
                }
        ...
        //Đăng nhập bằng phím Enter ở textbox
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                try
                {
                    ...
                    if (count > 0)
                    {
                        ...
                        GymDataFormRec home = new GymDataFormRec();
                        home.Show();
                        this.Hide();
                    }
                    else
